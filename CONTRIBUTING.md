...
2. **Never create, rename, or delete agent cards** under [agents/](file:///Users/bluestella/repositories/bluestella-agency-pack/agents) unless explicitly instructed by a human. The roster is intentional and version-controlled.
...
* **Templates & Guidelines**:
  * Scoped System Guidelines: [agent-role-card.instructions.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/instructions/agent-role-card.instructions.md)
  * Markdown Template: [agent-role-card.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/agent-role-card.md)
...
* **Folder Structure**:
  ...
  ```
* **Templates & Guidelines**:
  * Scoped System Guidelines: [skill-authoring.instructions.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/instructions/skill-authoring.instructions.md)
  * Markdown Template: [skill-md.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/skill-md.md)
...
Hooks capture the trigger boundaries modeling the workflow loops defined in [PLANS.md](file:///Users/bluestella/repositories/bluestella-agency-pack/PLANS.md) Step 2.

* **File Location**: `hooks/[source-agent-shortname]-[event]-feedback.md`
* **Templates & Guidelines**:
  * Scoped System Guidelines: [hook-authoring.instructions.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/instructions/hook-authoring.instructions.md)
  * Markdown Template: [hook-definition.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/hook-definition.md)
...
Developer-facing coding guidelines and standards live in the root [instructions/](file:///Users/bluestella/repositories/bluestella-agency-pack/instructions) directory. These files govern code patterns, validation strategies, and testing requirements across directories.

* **File Location**: `instructions/[instruction-name].instructions.md`
* **Example**: [api-patterns.instructions.md](file:///Users/bluestella/repositories/bluestella-agency-pack/instructions/api-patterns.instructions.md)
...
* **Exemplary Templates**:
  * Architecture Epic: [brd-epic.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/brd-epic.md)
  * API Endpoint Boilerplate: [api-endpoint.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/api-endpoint.md)
  * Data Persistence Layer: [repository-pattern.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/repository-pattern.md)
  * Testing Scaffolds: [test-file.md](file:///Users/bluestella/repositories/bluestella-agency-pack/.github/templates/test-file.md)
